...
bounty-description-cardobard-box = Завтра состоится премьера новой пьесы "Нашествие кардборгов", а костюмеры совершенно не подготовились. Пришлите нам несколько коробок для работы.
