...
emergency-shuttle-command-round-desc = Останавливает таймер, который завершает раунд, когда эвакуационный шаттл выходит из гиперпространства.
emergency-shuttle-command-dock-desc = Вызывает эвакуационный шаттл и пристыковывает его к станции... если это возможно.
emergency-shuttle-command-launch-desc = Осуществляет досрочный запуск эвакуационного шаттла, если возможно.
