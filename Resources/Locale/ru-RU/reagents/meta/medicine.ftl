...
reagent-desc-traumoxadone = Криогенное химическое вещество. Используется для лечения тяжёлых травм тканей путём их заполнения крошечными частицами внутри жидкости. Работает независимо от того, жив пациент или мёртв.

reagent-name-stelloxadone = стеллоксадон
reagent-desc-stelloxadone = Криогенное химическое вещество. Используется для агрессивного растворения токсинов из организма. Работает независимо от того, жив пациент или мёртв.
