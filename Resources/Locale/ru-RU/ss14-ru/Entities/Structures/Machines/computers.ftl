...
ent-WizardComputerComms = консоль связи волшебника
    .desc = Компьютер, способный магическим образом транслировать вашу речь на станцию. Использование этого для объявления предупредит станцию о вашем присутствии.
