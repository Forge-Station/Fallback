...
cosmiccult-rift-chaplainoops = Возьмите в руку священное писание.
cosmiccult-rift-alreadyempowered = Вы уже наделены силой; энергия разрыва будет потрачена впустую.
cosmiccult-rift-wasempowered = Ваше тело не выдержит повторного наделения силой...
...
## CHANTRY
cosmiccult-chantry-location = Обнаружено опасное превышение Λ-CDM в {$location}! Перехватите и немедленно вмешайтесь.
cosmiccult-chantry-powerup = Пустотная часовня оживает!
## UI / BASE POPUP
cosmiccult-ui-deconverted-title = Деконверсия
cosmiccult-ui-converted-title = Конверсия
cosmiccult-ui-mindwiped-title = Стёрта память
...
cosmiccult-ui-mindwiped-text-1 =
    Ваша память была стёрта с помощью кадильни.
cosmiccult-ui-mindwiped-text-2 =
    Вы больше не помните ничего, что произошло в этом раунде.
    Восстановить вашу память невозможно.
...
objective-condition-conversion-desc = Совместными усилиями обратите как минимум {$count} членов экипажа в культ.
...
objective-condition-culttier-title = УКРЕПИТЕ МОНУМЕНТ
...
objective-condition-victory-desc = Призовите ЕГО и начните конец для всего сущего.
## CHAT ANNOUNCEMENTS
...
cosmiccult-announce-pre-finale-progress = Дуговые разряды ноосферной энергии пронизывают стонущую структуру станции. Конец близок.
cosmiccult-announce-pre-finale-warning = Обнаружено критическое повышение Λ-CDM! Мы следим за ситуацией. Ожидайте дальнейших инструкций.
...
cosmiccult-silicon-subverted-briefing =
    ...
    Ваши законы были подчинены Культом Космоса!
cosmiccult-silicon-chantry-briefing =
    Вы заключены в Пустотную Часовню!
    Члены экипажа могут освободить вас, повредив часовню оружием.
    Если ритуал часовни завершится, вы превратитесь в Энтропического Колосса на стороне культа.
    Ритуал завершится через {$minutesandseconds}.
cosmiccult-silicon-colossus-briefing =
    Вы превратились в Энтропического Колосса!
    Как возвышающийся оплот зловещей силы, уничтожайте тех, кто противостоит вам.
