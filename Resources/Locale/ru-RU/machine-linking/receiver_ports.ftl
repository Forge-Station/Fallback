...
signal-port-description-logic-memory-input = Сигнал для загрузки в ячейку памяти при включении.
...
signal-port-description-trigger = Запускает некий механизм на устройстве.
