...
cmd-cvar_subs-invalid-args = Необходимо предоставить ровно один аргумент.
cmd-cvar_subs-arg-name = <имя>
cmd-savemap-error = Не удалось сохранить карту! Подробности см. в логе сервера.
cmd-showrot-desc = Показать вращение всех сущностей на экране.
...
cmd-reloadtiletextures-desc = Перезагружает атлас текстур плиток для горячей перезагрузки спрайтов плиток
...
cmd-localization_set_culture-help = Использование: localization_set_culture <имя культуры>
