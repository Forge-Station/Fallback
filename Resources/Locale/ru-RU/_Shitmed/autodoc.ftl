...
autodoc-view-program-title = ПРОСМОТР ПЛАНА
autodoc-safety-enabled = БЕЗОПАСНОСТЬ ВКЛ.
autodoc-safety-disabled = БЕЗОПАСНОСТИ ВЫКЛ.
...
autodoc-import-program = ИМПОРТ ПРОГРАММЫ
autodoc-export-program = ЭКСПОРТ ПРОГРАММЫ

autodoc-add-step-surgery = НАЧАТЬ ОПЕРАЦИЮ
...
autodoc-add-step-store-item = ПОМЕСТИТЬ ПРЕДМЕТ В ХРАНИЛИЩЕ
