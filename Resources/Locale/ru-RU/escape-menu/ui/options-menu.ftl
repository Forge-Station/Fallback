...
ui-options-function-swap-hands-reverse = Поменять руки (обратное направление)
...
ui-options-function-text-tab-complete = Tab-дополнение
...
ui-options-admin-player-tab-symbol-setting = Символы антагонистов в столбце персонажей
...
ui-options-admin-player-tab-role-setting-subtype = Показать подтип
ui-options-admin-player-tab-role-setting-roletypesubtype = Показать тип роли и подтип
...
ui-options-admin-overlay-antag-format-subtype = Показать подтип
...
ui-options-admin-enable-overlay-playtime = Показать наигранное время
ui-options-admin-enable-overlay-starting-job = Показать начальную работу
