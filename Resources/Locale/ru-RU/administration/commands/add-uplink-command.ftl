...
add-uplink-command-description = Создаёт аплинк на выбранном предмете и привязывает его к аккаунту пользователя
add-uplink-command-help = Использование: adduplink [имя пользователя] [id предмета]
