...
ghost-role-information-syndie-disaster-victim-name = Беженец Синдиката
...
ghost-role-information-Shiva-description = Шива, первый защитник станции. Помогайте главе службы безопасности в их работе.
ghost-role-information-Shiva-rules = Защищайте сотрудников СБ и экипаж от опасности. Оставайтесь с сотрудниками СБ или около отдела безопасности, старайтесь обезвредить преступников, а не убивать их, если ситуация позволяет.
ghost-role-information-exterminator-name = Терминатор
ghost-role-information-exterminator-description = Вы были отправлены назад во времени, чтобы уничтожить цель, имеющую большое значение для будущего.
